...
ALLOWED_HOSTS = ['homerealty.herokuapp.com', '127.0.0.1']
...
if not DEBUG:
    ...
    GS_PROJECT_ID = "tribal-isotope-279817"
    GS_MEDIA_BUCKET_NAME = 'realbuck9172'
...
CKEDITOR_UPLOAD_PATH = 'blog-uploads/%Y-%m'